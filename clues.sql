...
-- Answer is  Holy See (Vatican City State)
...
SELECT city.name
FROM cities city
JOIN countries country ON city.countrycode = country.code
...
FROM cities city
JOIN countries country ON city.id = country.capital
